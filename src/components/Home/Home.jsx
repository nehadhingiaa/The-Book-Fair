    ...
    <div className='holder'>
        <header>
           ...
           <div className='header-content flex flex-c text-center text-white'>
            <h2 className='header-title text-capitalized'>{t("homeScreenHeader")}</h2><br/>
       ...
       <footer className="fixed bottom-0 left-0 right-0 h-[70px] bg-white flex items-center justify-between px-10 shadow-purple-300">
        <div className="text-gray-700 font-semibold flex justify-center gap-2"><span><SiBookstack /></span><span>{t("homePageHeader")}</span></div>
